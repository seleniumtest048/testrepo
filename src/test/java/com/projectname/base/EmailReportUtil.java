		...
		try {
		   ...
		   if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")){
			...
			//out.write("<h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> Detailed Report :</h4>");
		 	 out.write("<table  border=1 cellspacing=1    cellpadding=1 width=100%>");
		 	/* out.write("<tr> ");
		        out.write("<td align=center width=10%  align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2><b>S.No.</b></td>");
		        out.write("<td align=center width=50% align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2><b>Test Steps</b></td>");
		 	 ...
		 	 if(description!=null){
		 		 for(int i=0;i<description.size();i++){
		 			...
		 			// out.write("<td align=center width=10%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b>Step"+(i+1)+"</b></td>");
	...
	public static void addTestCaseSteps(String testCaseName,String status){
		...
		try {
		 ...
		 //    out.write("<td width=10% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>"+scriptNumber+"</b></td>\n");
		     ...
		     out.write("<td width=20% align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>"+""+"</b></td>\n");
		     out.write("<td width=20% align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>"+""+"</b></td>\n");
